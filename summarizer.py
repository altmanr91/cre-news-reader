...
- If the article is primarily about a corporate acquisition, merger, or company purchase where the transaction transfers a company's equity or business rather than specific real estate assets — set article_type to "Non-CRE / Business News" rather than Sale or Acquisition. The key test: is the primary asset being transferred a specific property or real estate portfolio, or is it a company's equity/business? A company being bought as an entity (brokerage firm, property management company, proptech firm, or REIT via share exchange) is Non-CRE / Business News even if the company owns real estate
- If the article is primarily about an insurance product, catastrophe bond, insurance-linked security, or investment fund structure that is only tangentially related to real estate (e.g., insurance-linked securities for data center risk), set article_type to exactly "Non-CRE / Business News". Exception: REIT capital markets events (IPOs, secondary equity offerings, REIT mergers, REIT debt issuances) are CRE content — do not classify them as Non-CRE / Business News
- If the article's primary subject is a crime, arrest, political protest, or civil dispute where real estate is incidental (e.g., a council member arrested at an eviction protest, property fraud involving a private residence), set article_type to "Non-CRE / Political & Crime News". Exception: civil litigation or regulatory disputes where the primary subject IS the real estate transaction or real estate finance — such as loan-to-own claims, lender liability suits, foreclosure challenges, or landlord rights lawsuits affecting the industry as a class (e.g., a federal eviction moratorium lawsuit by thousands of landlords) — are CRE content and should NOT be classified as Non-CRE. Also exception: regulatory probes, enforcement actions, or fraud investigations involving CRE investment vehicles — including TIC (Tenant-in-Common) structures, DST (Delaware Statutory Trust) offerings, and 1031 exchange schemes — are CRE content and should be classified as "CRE Legal / Regulatory"
...
- Do not use transaction_type Promotion for association or trade organization board elections, officer elections, or leadership announcements (BOMA, NAIOP, NAR, CREW, ULI, and similar industry bodies) — these are not personal career promotions. Set article_type to "Association / Leadership News" instead
...
- For Lease articles, leave total_project_cost null even if the article mentions the building's construction or development cost — that figure describes the building's history, not the cost of the lease transaction. Example: if a tenant leases 38,000 SF in a campus that cost $1.2B to develop, total_project_cost must be null
...
- Government bodies, municipalities, or regulatory agencies should NOT be listed as transaction parties in any context — this includes agencies issuing permits, approvals, or incentives AND agencies with antitrust, merger review, or regulatory oversight roles (e.g. FTC, DOJ, SEC, state labor departments). Only include a government entity when it is a direct buyer, seller, landlord, tenant, lender, or developer in the transaction
- Do not include competitors, industry peers, or other companies mentioned solely as market context or comparison points — only include parties who are direct participants in this specific transaction
- Do not include attorneys, law firms, or individual lawyers named in a litigation or regulatory context — only include legal counsel if the article explicitly states they are representing a specific buyer, seller, lender, or borrower in this real estate transaction
...
- Do not include companies that the sponsor has invested in as a financial investor (venture capital or private equity portfolio companies) — only include specific real estate projects where the sponsor is explicitly named as developer, owner, builder, or borrower on that project
